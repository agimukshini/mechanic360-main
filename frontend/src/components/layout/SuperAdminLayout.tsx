...
const NAV_ITEMS = [
  ...
  { to: '/admin/subscriptions', tk: 'superAdminLayout.navSubscriptions', icon: CreditCard },
  ...
  { to: '/admin/invoices', tk: 'superAdminLayout.navInvoices', icon: Receipt },
  { to: '/admin/company', tk: 'superAdminLayout.navCompany', icon: Landmark },
